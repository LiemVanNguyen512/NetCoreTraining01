...
namespace Infrastructure.ScheduledJobs
{
    ...
    {
        public static IServiceCollection AddConfigHangfireSerivce(this IServiceCollection services)
        {
        ...
        private static IServiceCollection ConfigureHangfireService(this IServiceCollection services, HangfireSettings settings)
        {
            ...
            switch (settings.Storage.DBProvider.ToLower())
            {
                ...
                case "mysql":
                    string connectionString = settings.Storage.ConnectionString;
                    ...
                    var mySqlStorage = new MySqlStorage(connectionString, mySqlStorageOptions);
